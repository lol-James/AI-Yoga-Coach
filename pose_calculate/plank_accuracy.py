...
def evaluate_plank_pose(landmarks):
    ...
    scores["Arm_Bone"] = round((left_score + right_score) / 2, 2)
    ...
    scores["Body_Bone "] = round((body_score_left + body_score_right) / 2, 2)
    ...
    scores["Triangle_bone"] = round((tri_score_left + tri_score_right) / 2, 2)
