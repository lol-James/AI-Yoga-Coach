...
def evaluate_warrior1_pose(landmarks):
    ...
    "Front_Hip_Bone": abs((leg_trunk or 0) - STANDARD_ANGLES["front_leg_trunk"]) if leg_trunk is not None else None,
    "Arm_Bone": abs((arm_avg or 0) - STANDARD_ANGLES["arm"]) if arm_avg is not None else None,
    "average_score": abs((arm_trunk_avg or 0) - STANDARD_ANGLES["arm_trunk"]) if arm_trunk_avg is not None else None
    }
    ...
    result = {**scores, "front": front, "back": back, "average_score": avg_score}
