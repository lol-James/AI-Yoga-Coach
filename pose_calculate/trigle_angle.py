...
def score_angle(perfect_angle, actual_angle, weight=100, tolerance=5, power=2):
...
def evaluate_triangle_pose(landmarks, perfect_trunk=74.74, perfect_pelvis=64.13, perfect_shoulder=170.59):
    def pt(index): 
    ...
    scores = {
        ...
        "average_score": round((trunk_score + pelvis_score + shoulder_score)/3 , 2)
    }
    return scores